...
const ViewStaffsComplaints = () => {
    ...
    const accept = (id) => {
        console.log(id);
        axios.get(`http://localhost:2000/api/complaint/accept-staff-complaints/${id}/${worker_id}`)
    ...
    useEffect(() => {
        ...
        axios
            .get(
                "http://localhost:2000/api/complaint/view-all-pending-complaints-staff/"
            )
            .then((response) => {
...
export default ViewStaffsComplaints;
