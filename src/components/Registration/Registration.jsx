...
const Registration = () => {
  ...
  const validate = (values)=>{
    ...
    if(!values.register_no){
      error.register_no ="Enter Your RegisterNumber"
    }
    if(!values.year){
      error.year ="Enter Your Studying Year"
    }
    if(!values.dep){
      error.dep ="Enter Your Department"
    }
    return error
  }
  ...
  <div className="row">
    ...
    <ToastContainer />
      <form onSubmit={registerSubmit}>
        ...
        />
        <br />
        <span style={{color:"red"}} > {formErrors.register_no? formErrors.register_no :""}</span>
        <input
          type="text"
          className="form-control"
          ...
          required=""
          name="register_no"
          value={inputs.register_no || ""}
          onChange={setRegister} 
          onClick={()=>{setformErrors({...formErrors,register_no:""})}}
        />
        <br />
        <span style={{color:"red"}} > {formErrors.dep? formErrors.dep :""}</span>
        <input
          type="text"
          className="form-control"
          ...
          value={inputs.dep || ""}
          onChange={setRegister} 
          onClick={()=>{setformErrors({...formErrors,dep:""})}}
          
        />
        <br />
        <span style={{color:"red"}} > {formErrors.year? formErrors.year :""}</span>
        <input
          type="text"
          className="form-control"
          ...
          value={inputs.year || ""}
          onChange={setRegister} 
          onClick={()=>{setformErrors({...formErrors,year:""})}}
